...
<div class="modal modal--" id="modal_particular" style="z-index: 100;">
  ...
  <div class="modal-particular">
    ...
    <div class="row una-columna titulo-modal" >
   ...
   <div class="texto-modal">
    <center class="texto-modal-visitas-centrar"  style="padding:30px 3px 3px 3px;">
      ...
      <p class="texto-modal-visitas-pie" ><?=$modalContenidoParticular3?></p>
    </center>
  </div>
  <div class="row una-columna" >
   <button type="button" class="center-fk-button" id="btn_aceptar_particular" style="font-size:0.9em;">He leído y estoy de acuerdo</button>
 </div>
  ...
  <div class="modal-institucion">
   ...
   <div class="texto-modal">
    <center class="texto-modal-visitas-centrar" style="padding:30px 3px 3px 3px;">
      ...
      <p class="texto-modal-visitas-pie" style="font-size:0.75em;" ><?=$modalContenidoInstitucion3?></p>
    </center>
  </div>
  <div class="row una-columna">
...
<div class="modal" id="ex1">
 ...
 <div class="texto-modal">
  ...
  <p style="padding-top: 50px;font-size: 13px;font-family: 'sans-serif-italic';text-align: center;">Se envió un email con la confirmación de su visita incluyendo el código de reserva.</p>
  <p style="font-size: 13px;font-family: 'sans-serif-italic';text-align: center;margin-bottom: 20px;">Dicho código será solicitado al momento de ingresar a realizar su visita.</p>
</div>
<hr>
<div style="display: grid;grid-template-columns: 22% 37% 40%;">
